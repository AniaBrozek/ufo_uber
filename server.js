...
const connection = mysql.createConnection({
  host: 'lightcoral-badger-606203.hostingersite.com',
  user: 'root',
  password: '',
  database: 'u327428081_ufo'
});
...
app.listen(port, () => {
  console.log(`Serwer działa na porcie https://lightcoral-badger-606203.hostingersite.com`);
});
