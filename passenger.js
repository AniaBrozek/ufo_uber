...
document.addEventListener("DOMContentLoaded", async () => {
    try { 
        const response = await fetch('http://lightcoral-badger-606203.hostingersite.com:443/vehicles');
...
try {
    const response = await fetch('http://lightcoral-badger-606203.hostingersite.com:443/location');
    const data = await response.json();
